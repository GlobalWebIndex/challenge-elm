...
var $author$project$Main$parentIs = F2(
	function (id, de) {
		if (de.$ === 'File') {
			var audience = de.a;
			return _Utils_eq(audience.folder, id);
		} else {
...
var $author$project$Data$Mocked$Folder = function (a) {
	return {$: 'Folder', a: a};
};
...
var $author$project$Decoder$audienceFolderDecoder = A4(
...
var $author$project$Data$Mocked$parsedAudienceFolders = function () {
	var _v0 = A2(
		...
		A2(
			...
			_List_fromArray(
				['data']),
			$elm$json$Json$Decode$list($author$project$Decoder$audienceFolderDecoder)),
		$author$project$Data$AudienceFolder$audienceFoldersJSON);
	if (_v0.$ === 'Ok') {
		var l = _v0.a;
		return A2($elm$core$List$map, $author$project$Data$Mocked$Folder, l);
	} else {
		return _List_Nil;
	}
}();
var $author$project$Data$Mocked$File = function (a) {
	return {$: 'File', a: a};
};
...
var $author$project$Decoder$audienceTypeDecoder = function (s) {
	switch (s) {
		case 'user':
			return $elm$json$Json$Decode$succeed($author$project$Data$Audience$Authored);
		case 'shared':
			return $elm$json$Json$Decode$succeed($author$project$Data$Audience$Shared);
		case 'curated':
			return $elm$json$Json$Decode$succeed($author$project$Data$Audience$Curated);
		default:
			return $elm$json$Json$Decode$fail('AudienceType \'' + (s + '\' does not exist.'));
	}
};
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Decoder$audienceDecoder = A5(
...
var $author$project$Data$Mocked$parsedAudiences = function () {
	var _v0 = A2(
		$elm$json$Json$Decode$decodeString,
		A2(
			$elm$json$Json$Decode$at,
			_List_fromArray(
				['data']),
			$elm$json$Json$Decode$list($author$project$Decoder$audienceDecoder)),
		$author$project$Data$Audience$audiencesJSON);
	if (_v0.$ === 'Ok') {
		var l = _v0.a;
		return A2($elm$core$List$map, $author$project$Data$Mocked$File, l);
	} else {
		return _List_Nil;
	}
}();
var $author$project$Data$Mocked$parsedDirectory = _Utils_ap($author$project$Data$Mocked$parsedAudienceFolders, $author$project$Data$Mocked$parsedAudiences);
...
var $author$project$Main$audienceFolderView = function (af) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Main$OpenFolder(af)),
				$elm$html$Html$Attributes$classList(
				_List_fromArray(
					[
						_Utils_Tuple2('dir-elem', true),
						_Utils_Tuple2('folder', true)
					]))
			]),
		_List_fromArray(
			[
...
var $author$project$Main$dirElemView = function (de) {
	if (de.$ === 'File') {
		var a = de.a;
		return $author$project$Main$audienceView(a);
	} else {
		var af = de.a;
...
var $author$project$Main$goUpView = function (model) {
	return ($elm$core$List$length(model.parents) > 0) ? _List_fromArray(
		[
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick($author$project$Main$GoUp),
					$elm$html$Html$Attributes$classList(
					_List_fromArray(
						[
							_Utils_Tuple2('dir-elem', true),
