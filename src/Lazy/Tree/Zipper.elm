...
{-| Performs exploration on the `Tree` in `Zipper`. See `Tree.isInTree` and `Tree.isInForest` for more information.
...
-}
isInZipper : (a -> Bool) -> Zipper a -> Bool
isInZipper predicate (Zipper t bs) =
    Tree.isInTree predicate t
