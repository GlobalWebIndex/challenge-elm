...
var $author$project$Main$MsgGotResultsAudienceFolder = function (a) {
	return {$: 'MsgGotResultsAudienceFolder', a: a};
};
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					$author$project$Main$cmdSearchFolder($author$project$Main$initModel),
					$author$project$Main$cmdSearchAudience($author$project$Main$initModel)
				])));
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MsgGotResultsAudienceFolder':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var data = result.a;
					var newModel = _Utils_update(
						model,
						{audienceFolder: data, errorMessage: $elm$core$Maybe$Nothing});
			...
			case 'MsgGotResultsAudience':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var data = result.a;
					var newModel = _Utils_update(
						model,
						{audience: data, errorMessage: $elm$core$Maybe$Nothing});
					return _Utils_Tuple2(newModel, $elm$core$Platform$Cmd$none);
				} else {
					var error = result.a;
					return _Utils_Tuple2(
