...
var $author$project$Data$AudienceFolder$audFolders = A2(
	...
	_List_Nil,
	A2($elm$json$Json$Decode$decodeString, $author$project$Data$AudienceFolder$folderDecoder, $author$project$Data$AudienceFolder$audienceFoldersJSON));
...
var $author$project$Data$Audience$decodeType = function () {
	var toType = function (b) {
		switch (b) {
			case 'user':
			...
			default:
				return $elm$json$Json$Decode$fail(b + 'is not valid type');
		}
	};
	return A2($elm$json$Json$Decode$andThen, toType, $elm$json$Json$Decode$string);
}();
var $author$project$Data$Audience$decodeItem = A2(
	$elm$json$Json$Decode$field,
	'data',
	$elm$json$Json$Decode$list(
		A3(
			...
			A3(
				$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
				'type',
				$author$project$Data$Audience$decodeType,
				A3(
					$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
					'name',
					$elm$json$Json$Decode$string,
