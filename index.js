...
var $author$project$Main$GotAudienceFolders = function (a) {
	return {$: 'GotAudienceFolders', a: a};
};
...
var $author$project$Data$Audience$decodeAudienceType = A2(
	...
	function (str) {
		switch (str) {
			...
			default:
				return $elm$json$Json$Decode$fail('Invalid audience type');
		}
	},
	$elm$json$Json$Decode$string);
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'FetchAudienceFolders':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{audienceFolders: $krisajenkins$remotedata$RemoteData$Loading}),
					$elm$core$Platform$Cmd$none);
			case 'GotAudienceFolders':
				if (msg.a.$ === 'Ok') {
					var audienceFolders = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								audienceFolders: $krisajenkins$remotedata$RemoteData$Success(audienceFolders)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								audienceFolders: $krisajenkins$remotedata$RemoteData$Failure(err)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'FetchAudiences':
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								audiences: $krisajenkins$remotedata$RemoteData$Success(audiences)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								audiences: $krisajenkins$remotedata$RemoteData$Failure(err)
							}),
						$elm$core$Platform$Cmd$none);
				}
