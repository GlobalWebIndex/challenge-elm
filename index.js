...
var $author$project$Main$Authored = {$: 'Authored'};
var $author$project$Main$Curated = {$: 'Curated'};
var $elm$core$Basics$False = {$: 'False'};
var $author$project$Main$Shared = {$: 'Shared'};
...
var $author$project$Data$AudienceFolder$audFolders = A2(
	$elm$core$Result$withDefault,
	_List_Nil,
	A2($elm$json$Json$Decode$decodeString, $author$project$Data$AudienceFolder$decodeJson, $author$project$Data$AudienceFolder$audienceFoldersJSON));
var $author$project$Main$initModel = {
	audience: _List_fromArray(
		[
			{folder: 2, id: 1, name: 'Audience1', type_: $author$project$Main$Authored},
			{folder: 3, id: 1, name: 'Audience2', type_: $author$project$Main$Shared},
			{folder: 5, id: 1, name: 'Audience3', type_: $author$project$Main$Authored},
			{folder: 6, id: 1, name: 'Audience4', type_: $author$project$Main$Authored},
			{folder: 2, id: 1, name: 'Audience5', type_: $author$project$Main$Shared},
			{folder: 1, id: 1, name: 'Audience6', type_: $author$project$Main$Authored},
			{folder: 2, id: 1, name: 'Audience7', type_: $author$project$Main$Curated},
			{folder: 5, id: 1, name: 'Audience8', type_: $author$project$Main$Authored},
			{folder: 0, id: 1, name: 'Audience9', type_: $author$project$Main$Curated}
		]),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Audience Browser')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('searchButton')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('searchIcon'),
										$elm$html$Html$Attributes$src('src/Svg/searchIcon.svg'),
										A2($elm$html$Html$Attributes$attribute, 'description', 'SearchIcon')
									]),
								_List_Nil)
							])),
						A2(
				...
				_List_fromArray(
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick($author$project$Main$MsgFolderClosed)
									]),
								_List_fromArray(
									[
						...
						A2(
							$elm$core$List$map,
							$author$project$Main$viewAudience(model.opened),
							model.audience))
					]))
			]));
};
